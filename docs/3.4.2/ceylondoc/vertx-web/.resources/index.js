...
{'name': 'MIMEHeader.component', 'type': 'function', 'url': 'MIMEHeader.type.html#component', 'doc': '<p>Gets the parsed component part of the MIME.</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'MIMEHeader.subComponent', 'type': 'function', 'url': 'MIMEHeader.type.html#subComponent', 'doc': '<p>Gets the parsed subcomponent part of the MIME.</p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'socket_idle', 'type': 'object', 'url': 'handler/sockjs/socket_idle.object.html', 'doc': '<p>This event will occur when SockJS socket is on idle for longer period of time than configured.</p>', 'tags': [],'icons': ['icon-object']},
{'name': 'socket_idle', 'type': 'value', 'url': 'handler/sockjs/index.html#socket_idle', 'doc': '<p>This event will occur when SockJS socket is on idle for longer period of time than configured.</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'socket_ping', 'type': 'object', 'url': 'handler/sockjs/socket_ping.object.html', 'doc': '<p>This event will occur when the last ping timestamp is updated for the SockJS socket.</p>', 'tags': [],'icons': ['icon-object']},
{'name': 'socket_ping', 'type': 'value', 'url': 'handler/sockjs/index.html#socket_ping', 'doc': '<p>This event will occur when the last ping timestamp is updated for the SockJS socket.</p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'BridgeEvent.type', 'type': 'function', 'url': 'handler/sockjs/BridgeEvent.type.html#type', 'doc': '', 'tags': [],'icons': ['icon-shared-member']},
