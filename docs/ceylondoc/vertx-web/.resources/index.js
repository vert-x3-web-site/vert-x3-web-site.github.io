...
{'name': 'BridgeEvent.otherwise', 'type': 'function', 'url': 'handler/sockjs/BridgeEvent.type.html#otherwise', 'doc': '<p>Map the failure of a future to a specific <code>value</code>.<p><', 'tags': [],'icons': ['icon-shared-member', 'icon-decoration-over']},
